...
def calculate_avail_vmem(mems):
    ...
    * https://github.com/famzah/linux-memavailable-procfs/issues/2
    ...
    try:
        ...
        debug(
            "%r is missing from /proc/meminfo; using an approximation "
    ...
    def decode_address(addr, family):
        ...
        if family == socket.AF_INET:
            ...
            try:
                ...
                if LITTLE_ENDIAN:
                    ip = socket.inet_ntop(
                        socket.AF_INET6, struct.pack(">4I", *struct.unpack("<4I", ip))
                    )
                else:
                    ip = socket.inet_ntop(
                        socket.AF_INET6, struct.pack("<4I", *struct.unpack("<4I", ip))
    ...
    if os.path.exists("/proc/%s/io" % os.getpid()):
        ...
        def io_counters(self):
            ...
            try:
                ...
                raise ValueError(
                    "%r field was not found in %s; found fields "
                    ...
                    if not fields[0].endswith(b":"):
                        ...
                        try:
                            ...
                            if fields[0].startswith(b"VmFlags:"):
                                ...
                                raise ValueError(
                                    "don't know how to inte" "rpret line %r" % line
                                )
                yield (current_block.pop(), data)
