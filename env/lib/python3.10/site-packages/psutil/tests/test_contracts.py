...
class TestAvailSystemAPIs(PsutilTestCase):
    ...
    def test_cpu_freq(self):
        self.assertEqual(
            hasattr(psutil, "cpu_freq"), LINUX or MACOS or WINDOWS or FREEBSD or OPENBSD
        )
    ...
    def test_battery(self):
        self.assertEqual(
            hasattr(psutil, "sensors_battery"), LINUX or WINDOWS or FREEBSD or MACOS
        )
...
class TestAvailProcessAPIs(PsutilTestCase):
    ...
    def test_cpu_affinity(self):
        self.assertEqual(
            hasattr(psutil.Process, "cpu_affinity"), LINUX or WINDOWS or FREEBSD
        )
