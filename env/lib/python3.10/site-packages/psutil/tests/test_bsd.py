...
class FreeBSDSystemTestCase(PsutilTestCase):
    ...
    def test_cpu_stats_ctx_switches(self):
        self.assertAlmostEqual(
            psutil.cpu_stats().ctx_switches, sysctl("vm.stats.sys.v_swtch"), delta=1000
        )

    def test_cpu_stats_interrupts(self):
        self.assertAlmostEqual(
            psutil.cpu_stats().interrupts, sysctl("vm.stats.sys.v_intr"), delta=1000
        )
    ...
    def test_cpu_stats_syscalls(self):
        ...
        self.assertAlmostEqual(
            psutil.cpu_stats().syscalls, sysctl("vm.stats.sys.v_syscall"), delta=200000
        )
    ...
    def test_sensors_battery_against_sysctl(self):
        ...
        self.assertEqual(
            psutil.sensors_battery().power_plugged, sysctl("hw.acpi.acline") == 1
        )
