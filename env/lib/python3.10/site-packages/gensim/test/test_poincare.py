...
class TestPoincareData(unittest.TestCase):
    def test_encoding_handling(self):
        ...
        relations = [
            relation for relation in PoincareRelations(non_utf8_file, encoding="cp852")
        ]
...
class TestPoincareModel(unittest.TestCase):
    ...
    def test_data_counts(self):
        ...
        self.assertEqual(
            len(model.node_relations[model.kv.get_index("kangaroo.n.01")]), 3
        )
    ...
    def test_gradients_check(self):
        ...
        try:
            ...
            self.fail(
                "Exception %s raised unexpectedly while training with gradient checking"
                % repr(e)
            )

    @unittest.skipIf(
        not autograd_installed, "autograd needs to be installed for this test"
    )
...
class TestPoincareKeyedVectors(unittest.TestCase):
    ...
    def test_most_similar(self):
        ...
        predicted = [
            result[0] for result in self.vectors.most_similar("dog.n.01", topn=5)
        ]
    ...
    def test_most_similar_to_given(self):
        ...
        predicted = self.vectors.most_similar_to_given(
            "dog.n.01", ["carnivore.n.01", "placental.n.01", "mammal.n.01"]
        )
    ...
    def test_distance(self):
        ...
        self.assertTrue(
            np.allclose(self.vectors.distance("dog.n.01", "mammal.n.01"), 4.5278745)
        )
    ...
    def test_descendants(self):
        ...
        self.assertEqual(
            self.vectors.descendants("dog.n.01", max_depth=3), expected[:3]
        )
    ...
    def test_similarity(self):
        ...
        self.assertTrue(
            np.allclose(self.vectors.similarity("dog.n.01", "mammal.n.01"), 0.180901358)
        )
    ...
    def test_difference_in_hierarchy(self):
        ...
        self.assertTrue(
            np.allclose(self.vectors.difference_in_hierarchy("dog.n.01", "dog.n.01"), 0)
        )
        self.assertTrue(
            np.allclose(
                self.vectors.difference_in_hierarchy("mammal.n.01", "dog.n.01"),
                0.9384287,
            )
        )
        self.assertTrue(
            np.allclose(
                self.vectors.difference_in_hierarchy("dog.n.01", "mammal.n.01"),
                -0.9384287,
            )
        )
    ...
    def test_closer_than(self):
        ...
        self.assertEqual(
            set(self.vectors.closer_than("dog.n.01", "carnivore.n.01")), expected
        )
